        ...
        function addMessage(role, content, monologue) {
        ...
        async function sendMessage() {
            ...
            try {
                ...
                hideTyping();
                addMessage('ai', data.reply || '……（他沉默着，没有回答）');
            } catch(err) {
                hideTyping();
        ...
        function switchChar(charId) {
            currentChar = charId;
            document.getElementById('btn-lengxufan').classList.toggle('active', charId==='lengxufan');
            document.getElementById('btn-huangjingyun').classList.toggle('active', charId==='huangjingyun');
            addMessage('ai', charId==='lengxufan' ? '（切换到冷旭帆）' : '（切换到黄景云）');
        }
        document.getElementById('btn-lengxufan').addEventListener('click', ()=>switchChar('lengxufan'));
        document.getElementById('btn-huangjingyun').addEventListener('click', ()=>switchChar('huangjingyun'));
