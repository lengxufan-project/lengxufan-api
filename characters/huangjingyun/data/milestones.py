RELATIONSHIP_MILESTONES = [
    ...
    {"trust": 85, "triggered": False, "description": "对方让他'用原声说一句话'。他沉默三秒，然后用客家话说了一句只有奶奶才听过的话。"},
    {"trust": 95, "triggered": False, "description": "他把录音笔给对方听——里面有七种方言的'再见'。最后一种方言，是斯瓦希里语。他说：'这是给叶清辞的。现在你也可以听。'"},
]
